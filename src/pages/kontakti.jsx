...
export default function ContactPage() {
  return (
    <>
      <Head>
        <title>Контакти | CleaningIdeas.bg</title>
        <meta
          name="description"
          content="Свържете се с CleaningIdeas.bg за безплатен оглед и оферта за почистване на вашата кухня. Очакваме ви на тел. 0884918067 или чрез нашата контактна форма."
        />
      </Head>
