...
const PROCESS_STEPS = [
  {
    ...
    description: "Третираме внимателно замърсените зони, за да започне разтварянето на наслоената мазнина.",
  },
  {
    image: "/4fans/etap_2.png",
    title: "Работна фаза и дълбоко почистване",
    description: "Препаратът работи в дълбочина и освобождава механичните части от натрупаните замърсявания.",
  },
  {
    image: "/4fans/etap_3.png",
    title: "Изплакване и финален контрол",
    description: "След изплакване правим проверка за чист мотор и стабилна работа на системата.",
  },
];
...
export default function ChisteneNaMotoriPage() {
  return (
    <main className="min-h-screen bg-white text-neutral-900">
      <section className="relative isolate overflow-hidden">
        <Image
          src="/4fans/etap_3.png"
          alt="Почистване на мотори"
          fill
          priority
          sizes="100vw"
          className="absolute inset-0 -z-20 object-cover object-center scale-95"
        />
        ...
        <div className="mx-auto max-w-6xl px-3 py-20 text-center text-white md:py-28">
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl">
            Почистване на
            <span className="block">мотори</span>
          </h1>
        </div>
      </section>
          ...
          <div className="relative overflow-hidden rounded-3xl border border-emerald-200 bg-white/85 p-6 shadow-[0_24px_50px_-36px_rgba(16,65,45,0.45)] backdrop-blur-[1px] md:p-8">
            ...
            <div className="relative">
              <h2 className="text-2xl font-bold tracking-tight text-neutral-900 sm:text-3xl">
                Защо трябва да се почиства моторът /двигателят/ ?
              </h2>
              <div className="mt-3 space-y-3 text-sm text-neutral-700 sm:text-base">
                <ul className="space-y-1 pl-5">
                  <li className="list-disc">Намаляване риска от пожар</li>
                  ...
                  <li className="list-disc">Намаляване разходите за електричество</li>
                  <li className="list-disc">Удължаване живота му</li>
                </ul>
      ...
      <section className="mx-auto max-w-6xl px-3 py-12 md:py-16">
        <div className="max-w-3xl">
          <h2 className="text-2xl font-bold tracking-tight sm:text-3xl">
            Мотори преди и след почистване
          </h2>
        </div>
              ...
              {[...BEFORE_AFTER_ITEMS, ...BEFORE_AFTER_ITEMS].map((item, index) => (
                ...
                >
                  <div className="relative">
                    <Image
                      src={item.image}
                      alt={`Разлика в мотори преди и след почистване - ${item.label}`}
                      width={1536}
                      height={1024}
